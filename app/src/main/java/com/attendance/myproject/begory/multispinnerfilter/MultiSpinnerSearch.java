...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
	...
	private int highlightColor = ContextCompat.getColor(getContext(), com.androidbuts.multispinnerfilter.R.color.list_selected);
	...
	public MultiSpinnerSearch(Context arg0, AttributeSet arg1) {
		super(arg0, arg1);
		TypedArray a = arg0.obtainStyledAttributes(arg1, com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch);
		for (int i = 0; i < a.getIndexCount(); ++i) {
			...
			if (attr == com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch_hintText) {
				...
				break;
			} else if (attr == com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch_highlightSelected) {
				highlightSelected = a.getBoolean(attr, false);
			} else if (attr == com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch_highlightColor) {
				highlightColor = a.getColor(attr, ContextCompat.getColor(getContext(), com.androidbuts.multispinnerfilter.R.color.list_selected));
			} else if (attr == com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch_textColor) {
				textColor = a.getColor(attr, Color.GRAY);
			}else if (attr == com.androidbuts.multispinnerfilter.R.styleable.MultiSpinnerSearch_clearText){
	...
	public void onCancel(DialogInterface dialog) {
		...
		ArrayAdapter<String> adapterSpinner = new ArrayAdapter<String>(getContext(),
				com.androidbuts.multispinnerfilter.R.layout.textview_for_spinner, new String[]{spinnerText});
	...
	public boolean performClick() {
		...
		final ListView listView = view.findViewById(com.androidbuts.multispinnerfilter.R.id.alertSearchListView);
		...
		final TextView emptyText = view.findViewById(com.androidbuts.multispinnerfilter.R.id.empty);
		emptyText.setText(emptyTitle);
		listView.setEmptyView(emptyText);

		final EditText editText = view.findViewById(com.androidbuts.multispinnerfilter.R.id.alertSearchEditText);
		if (isSearchEnabled) {
...
//		this.listener = listener;
	...
	public void setItemsListener(MultiSpinnerListener listener) {
		this.listener = listener;
	}
...
//            //Log.i(TAG, "getView() enter");
			...
			if (convertView == null) {
				...
				holder.textView = convertView.findViewById(com.androidbuts.multispinnerfilter.R.id.alertTextView);
				holder.checkBox = convertView.findViewById(com.androidbuts.multispinnerfilter.R.id.alertCheckbox);
			...
			int background = com.androidbuts.multispinnerfilter.R.color.white;
			if (colorSeparation) {
