...
public class SingleSpinnerSearch extends androidx.appcompat.widget.AppCompatSpinner implements OnCancelListener {
	private static final String TAG = com.androidbuts.multispinnerfilter.SingleSpinnerSearch.class.getSimpleName();
	...
	public void onCancel(DialogInterface dialog) {
		...
		ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), com.androidbuts.multispinnerfilter.R.layout.textview_for_spinner, new String[]{spinnerText});
	...
	public boolean performClick() {
		...
		View view = inflater.inflate(com.androidbuts.multispinnerfilter.R.layout.alert_dialog_listview_search, null);
		...
		EditText editText = view.findViewById(com.androidbuts.multispinnerfilter.R.id.alertSearchEditText);
		if (isSearchEnabled) {
	...
	public class MyAdapter extends BaseAdapter implements Filterable {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = inflater.inflate(com.androidbuts.multispinnerfilter.R.layout.item_listview_single, parent, false);
			...
			int color = com.androidbuts.multispinnerfilter.R.color.white;
			if (colorseparation) {
			...
			if (data.isSelected()) {
				...
				convertView.setBackgroundColor(ContextCompat.getColor(getContext(), com.androidbuts.multispinnerfilter.R.color.list_selected));
			} else {
