...
//
//    protected fun attachLayoutAnimationParameters(child: View?, params: ViewGroup.LayoutParams,
//                                                  index: Int, count: Int) {
//        val layoutManager: LayoutManager = getLayoutManager()
//        if (getAdapter() != null && layoutManager is GridLayoutManager) {
...
//            val columns: Int = (layoutManager as GridLayoutManager).getSpanCount()
