...
public abstract class Hilt_AddBonusActivity extends BaseActivity1 implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((AddBonusActivity_GeneratedInjector) generatedComponent()).injectAddBonusActivity(UnsafeCasts.<AddBonusActivity>unsafeCast(this));
  }
